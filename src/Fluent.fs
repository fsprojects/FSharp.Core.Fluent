// Copyright (c) Microsoft Open Technologies, Inc and other contributors.  All Rights Reserved.  Licensed under the Apache License, Version 2.0.  See License.txt in the project root for license information.
...
module SeqExtensions = 
    ...
    type System.Collections.Generic.IEnumerable<'T> with 
        ...
        member inline source.Item(index:int) = 
#if FSHARP_CORE_AT_LEAST_4_0
...
module ArrayExtensions = 
    ...
    type ``[]``<'T> with
...
#else
        member inline arr.countBy(projection:('T -> 'Key)) = Seq.countBy projection arr |> Seq.toArray
#endif
...
#else
        member inline arr.distinctBy(projection:('T -> 'Key)) = Seq.distinctBy projection arr |> Seq.toArray
#endif
        ...
        /// <exception cref="System.ArgumentNullException">Thrown when the input array is null.</exception>
#if FSHARP_CORE_AT_LEAST_4_0
        member inline arr.groupBy(projection:('T -> 'Key)) = Array.groupBy projection arr
#else
        member inline arr.groupBy(projection:('T -> 'Key)) = Seq.groupBy projection arr |> Seq.map (fun (k,vs) -> (k,Seq.toArray vs)) |> Seq.toArray
#endif
        ...
        /// <exception cref="System.ArgumentNullException">Thrown when the input sequence is null.</exception>
#if FSHARP_CORE_AT_LEAST_4_0
        member inline arr.pairwise() = Array.pairwise arr
#else
        member inline arr.pairwise() = Seq.pairwise arr |> Seq.toArray
#endif
...
#else
        member inline arr.skip(count:int) = Seq.skip count arr |> Seq.toArray
#endif
        ...
        /// <exception cref="System.ArgumentNullException">Thrown when the input array is null.</exception>
#if FSHARP_CORE_AT_LEAST_4_0
        member inline arr.skipWhile(predicate:('T -> bool)) = Array.skipWhile predicate arr
#else
        member inline arr.skipWhile(predicate:('T -> bool)) = Seq.skipWhile predicate arr |> Seq.toArray
#endif
...
#else
        member inline arr.take(count:int) = Seq.take count arr |> Seq.toArray
#endif
        ...
        /// <exception cref="System.ArgumentNullException">Thrown when the input array is null.</exception>
#if FSHARP_CORE_AT_LEAST_4_0
        member inline arr.takeWhile(predicate:('T -> bool)) = Array.takeWhile predicate arr
#else
        member inline arr.takeWhile(predicate:('T -> bool)) = Seq.takeWhile predicate arr |> Seq.toArray
#endif
...
#if FSHARP_CORE_AT_LEAST_4_0
        member inline arr.truncate(count:int) = Array.truncate count arr
#else
        member inline arr.truncate(count:int) = Seq.truncate count arr |> Seq.toArray
#endif
        ...
        /// <exception cref="System.ArgumentNullException">Thrown when the input array is null.</exception>
#if FSHARP_CORE_AT_LEAST_4_0
        member inline arr.where(predicate:('T -> bool)) = Array.where predicate arr
#else
        member inline arr.where(predicate:('T -> bool)) = Array.filter predicate arr
#endif
        ...
        /// <exception cref="System.ArgumentException">Thrown when windowSize is not positive.</exception>
#if FSHARP_CORE_AT_LEAST_4_0
        member inline arr.windowed(windowSize:int) = Array.windowed windowSize arr
#else
        member inline arr.windowed(windowSize:int) = Seq.windowed windowSize arr |> Seq.toArray
#endif
        ...
        /// <exception cref="System.ArgumentNullException">Thrown when the input array is null.</exception>
        member inline arr.indexed() = Array.indexed arr
#endif
        ...
        /// <param name="projection">The function to transform array elements into the type that is compared.</param>
        /// <returns>The sorted array.</returns>
        member inline arr.sortByDescending(projection:('T -> 'Key)) = Array.sortByDescending projection arr
        ...
        member inline arr.tryFindIndexBack(predicate:('T -> bool)) = Array.tryFindIndexBack predicate arr
        ...
        member inline arr.tryFindBack(predicate:('T -> bool)) = Array.tryFindBack predicate arr
        ...
        /// <exception cref="System.ArgumentNullException">Thrown when the input array is null.</exception>
        member inline arr.tryItem(index:int) = Array.tryItem index arr
        ...
        member inline arr.tail() = Array.tail arr
...
#else
    static member inline distinct(array:'T[]) = Seq.distinct array |> Seq.toArray
#endif
...
#else
        member inline list.countBy(projection:('T -> 'Key)) = Seq.countBy projection list |> Seq.toList
#endif
...
#else
        member inline list.distinctBy(projection:('T -> 'Key)) = Seq.distinctBy projection list |> Seq.toList
#endif
...
#else
        member inline list.groupBy(projection:('T -> 'Key)) = Seq.groupBy projection list |> Seq.map (fun (k,vs) -> (k,Seq.toList vs)) |> Seq.toList
#endif
...
#else
        member inline list.pairwise() = Seq.pairwise list |> Seq.toList
#endif
...
#else
        member inline list.skip(count:int) = Seq.skip count list |> Seq.toList
#endif
...
#else
        member inline list.skipWhile (predicate:('T -> bool)) = Seq.skipWhile predicate list |> Seq.toList
#endif
...
#else
        member inline list.take(count:int) = Seq.take count list |> Seq.toList
#endif
...
#else
        member inline list.takeWhile(predicate:('T -> bool)) = Seq.takeWhile predicate list |> Seq.toList
#endif
...
#else
        member inline list.truncate(count:int) = Seq.truncate count list |> Seq.toList
#endif
...
#else
        member inline list.where(predicate:('T -> bool)) = List.filter predicate list
#endif
...
#else
        member inline list.windowed(windowSize:int) = Seq.windowed windowSize list |> Seq.toList
#endif
...
#else
    static member inline distinct(list:'T list) = Seq.distinct list |> Seq.toList
#endif
